...
> `4c9378e` from `merge/gas-forecast-into-v2`, deployed 8 September 17:48:24 UTC,
> asset stamp `2026-09-08f`. The owner authorised it explicitly as an interim while
...
> engine to 9.8e-16. Rollback archive of the previous tree (`d36d6a9`):
